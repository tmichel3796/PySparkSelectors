...
check:
    UV_LINK_MODE=copy UV_CONCURRENT_INSTALLS=4 uv run --python=3.14 ruff format --check .
    UV_LINK_MODE=copy UV_CONCURRENT_INSTALLS=4 uv run --python=3.14 ruff check .
    UV_LINK_MODE=copy UV_CONCURRENT_INSTALLS=4 uv run --python=3.14 ty check .
